...
import { Heart, BookOpen, MessageCircle, Bookmark, Edit, Trash2, MoreVertical } from 'lucide-react';
...
const StoryCard = ({ story, onDelete }) => {
  ...
  const handleBookmark = async (e) => {
    ...
    try {
      ...
      toast.success(response.data.bookmarked ? 'Story bookmarked!' : 'Story removed from bookmarks');
    } catch (error) {
